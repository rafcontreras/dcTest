...
/******/ 	return __webpack_require__(__webpack_require__.s = "./node_modules/workerize-loader/dist/rpc-worker-loader.js!./src/workers/shopping.worker.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./node_modules/gatsby/node_modules/core-js/internals/array-species-create.js":
/*!************************************************************************************!*\
  !*** ./node_modules/gatsby/node_modules/core-js/internals/array-species-create.js ***!
  \************************************************************************************/
/*! no static exports found */
...
/***/ "./node_modules/gatsby/node_modules/core-js/internals/flatten-into-array.js":
/*!**********************************************************************************!*\
  !*** ./node_modules/gatsby/node_modules/core-js/internals/flatten-into-array.js ***!
  \**********************************************************************************/
/*! no static exports found */
...
var defineProperties = __webpack_require__(/*! ../internals/object-define-properties */ "./node_modules/gatsby/node_modules/core-js/internals/object-define-properties.js");
...
/***/ "./node_modules/gatsby/node_modules/core-js/modules/es.array.flat.js":
/*!***************************************************************************!*\
  !*** ./node_modules/gatsby/node_modules/core-js/modules/es.array.flat.js ***!
  \***************************************************************************/
/*! no static exports found */
...
var flattenIntoArray = __webpack_require__(/*! ../internals/flatten-into-array */ "./node_modules/gatsby/node_modules/core-js/internals/flatten-into-array.js");
var toObject = __webpack_require__(/*! ../internals/to-object */ "./node_modules/gatsby/node_modules/core-js/internals/to-object.js");
var toLength = __webpack_require__(/*! ../internals/to-length */ "./node_modules/gatsby/node_modules/core-js/internals/to-length.js");
var toInteger = __webpack_require__(/*! ../internals/to-integer */ "./node_modules/gatsby/node_modules/core-js/internals/to-integer.js");
var arraySpeciesCreate = __webpack_require__(/*! ../internals/array-species-create */ "./node_modules/gatsby/node_modules/core-js/internals/array-species-create.js");
...
/***/ "./node_modules/gatsby/node_modules/core-js/modules/es.array.unscopables.flat.js":
/*!***************************************************************************************!*\
  !*** ./node_modules/gatsby/node_modules/core-js/modules/es.array.unscopables.flat.js ***!
  \***************************************************************************************/
/*! no static exports found */
...
/***/ "./node_modules/react-data-fetching/esm/react-data-fetching.js":
/*!*********************************************************************!*\
  !*** ./node_modules/react-data-fetching/esm/react-data-fetching.js ***!
  \*********************************************************************/
/*! exports provided: ConnectedFetch, Fetch, FetchProvider, requestToApi */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ConnectedFetch", function() { return ConnectedFetch; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "requestToApi", function() { return requestToApi; });
...
var createConnectedFetch = function createConnectedFetch() {
  ...
  if (true) {
    ConnectedFetch.prototype.componentWillReceiveProps = function (nextProps) {
      !(
      // $FlowFixMe
      _this2.rdfApi === nextProps.api) ?  true ? invariant_1(false, '<ConnectedFetch> does not support changing `api` on the fly.') : undefined : void 0;
      !(
      // $FlowFixMe
      _this2.rdfHeaders === nextProps.headers) ?  true ? invariant_1(false, '<ConnectedFetch> does not support changing `headers` on the fly.') : undefined : void 0;
      !(
      // $FlowFixMe
      _this2.rdfLoader === nextProps.loader) ?  true ? invariant_1(false, '<ConnectedFetch> does not support changing `loader` on the fly.') : undefined : void 0;
      !(
      // $FlowFixMe
      _this2.rdfInterceptor === nextProps.onIntercept) ?  true ? invariant_1(false, '<ConnectedFetch> does not support changing `onIntercept` on the fly.') : undefined : void 0;
      !(
      // $FlowFixMe
      _this2.rdfStore === nextProps.store) ?  true ? invariant_1(false, '<ConnectedFetch> does not support changing `store` on the fly.') : undefined : void 0;
      !(
      // $FlowFixMe
      _this2.rdfTimeout === nextProps.timeout) ?  true ? invariant_1(false, '<ConnectedFetch> does not support changing `timeout` on the fly.') : undefined : void 0;
    };
  }
...
var Fetch = function (_Component) {
  ...
  function Fetch() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, _Component.call.apply(_Component, [this].concat(args))), _this), _this._data = undefined, _this._didCallOnLoad = false, _this._isLoaded = false, _this._isUnmounted = false, _this._fetchData = function () {
            ...
            switch (_context.prev = _context.next) {
              ...
              case 12:
                ...
                if (!_this._isUnmounted) {
                  ...
                  if (true) {
                    !!_context.t0 ?  true ? invariant_1(false, '<Fetch /> tried to call the route "' + String(route) + '" ' + ('with "' + String(method).toUpperCase() + '" method ') + 'but resolved with the following error: %s\n', _this._printError(_context.t0)) : undefined : void 0;
                  }
                }
      ...
      !(path || url) ?  true ? invariant_1(false, 'You must provide a `url` or a `path` to <Fetch />') : undefined : void 0;

      if (path) {
        !(path && rdfApi) ?  true ? invariant_1(false, 'You must implement <FetchProvider> at the root of your ' + 'app and provide an `api` in order to use `path`') : undefined : void 0;
      }

      if (path === 'store') {
        !(path && rdfStore) ?  true ? invariant_1(false, 'You must implement <FetchProvider> at the root of your ' + 'app and provide a `store` in order to use `path="store"`') : undefined : void 0;
      }

      if (onTimeout) {
        !(typeof timeout === 'number' && timeout >= 0 || typeof rdfTimeout === 'number' && rdfTimeout >= 0) ?  true ? invariant_1(false, 'You must provide a `timeout` number in ms to <Fetch /> or ' + '<FetchProvider> in order to use `onTimeout`') : undefined : void 0;
      }

      !(children || component || render || onFetch) ?  true ? invariant_1(false, 'You must provide at least one of the following ' + 'to <Fetch />: children, `component`, `onFetch`, `render`') : undefined : void 0;
  ...
  Fetch.prototype.render = function render() {
    ...
    if (this._isLoaded && !this._isUnmounted) {
      if (component) return Object(react__WEBPACK_IMPORTED_MODULE_0__["createElement"])(component, this._data);

      if (typeof render === 'function') return render(this._data);

      if (typeof children === 'function') return children(this._data);

      if (children && !isEmptyChildren(children)) return react__WEBPACK_IMPORTED_MODULE_0__["Children"].only(children);
    }
...
var createFetchProvider = function createFetchProvider() {
  ...
  if (true) {
    FetchProvider.prototype.componentWillReceiveProps = function (nextProps) {
      !(
      // $FlowFixMe
      _this2$1.rdfApi === nextProps.api) ?  true ? invariant_1(false, '<FetchProvider> does not support changing `api` on the fly.') : undefined : void 0;
      !(
      // $FlowFixMe
      _this2$1.rdfHeaders === nextProps.headers) ?  true ? invariant_1(false, '<FetchProvider> does not support changing `headers` on the fly.') : undefined : void 0;
      !(
      // $FlowFixMe
      _this2$1.rdfLoader === nextProps.loader) ?  true ? invariant_1(false, '<FetchProvider> does not support changing `loader` on the fly.') : undefined : void 0;
      !(
      // $FlowFixMe
      _this2$1.rdfInterceptor === nextProps.onIntercept) ?  true ? invariant_1(false, '<FetchProvider> does not support changing `onIntercept` on the fly.') : undefined : void 0;
      !(
      // $FlowFixMe
      _this2$1.rdfStore === nextProps.store) ?  true ? invariant_1(false, '<FetchProvider> does not support changing `store` on the fly.') : undefined : void 0;
      !(
      // $FlowFixMe
      _this2$1.rdfTimeout === nextProps.timeout) ?  true ? invariant_1(false, '<FetchProvider> does not support changing `timeout` on the fly.') : undefined : void 0;
    };
  }
...
/***/ "./node_modules/workerize-loader/dist/rpc-worker-loader.js!./src/workers/shopping.worker.js":
/*!**************************************************************************************************!*\
  !*** ./node_modules/workerize-loader/dist/rpc-worker-loader.js!./src/workers/shopping.worker.js ***!
  \**************************************************************************************************/
/*! exports provided: dashboardFunctions */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "dashboardFunctions", function() { return dashboardFunctions; });
/* harmony import */ var _utils_handleMessage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/handleMessage */ "./src/utils/handleMessage.js");
/* harmony import */ var _utils_restFunctions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/restFunctions */ "./src/utils/restFunctions.js");
/* harmony import */ var _utils_handleResponseFromAPI__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/handleResponseFromAPI */ "./src/utils/handleResponseFromAPI.js");
...
const dashboardFunctions = async ({
  ...
  if (kind === "shoppingListData" && method) {
    const message = await Object(_utils_restFunctions__WEBPACK_IMPORTED_MODULE_1__["getShoppingListData"])(method)
      .then(response => {
        const object = Object(_utils_handleResponseFromAPI__WEBPACK_IMPORTED_MODULE_2__["default"])(response, kind);
        return Object(_utils_handleMessage__WEBPACK_IMPORTED_MODULE_0__["default"])({ object, options, kind, method });
      })
      .catch(() => {
        return null;
      });
...
/***/ "./src/utils/camelToSentenceCase.js":
/*!******************************************!*\
  !*** ./src/utils/camelToSentenceCase.js ***!
  \******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var camelToSentenceCase = function camelToSentenceCase(key) {
  var firstUpperCase = "" + key.charAt(0).toUpperCase() + key.slice(1);
  var replaced = firstUpperCase.replace(/([A-Z])/g, " $1");
  return replaced.trim();
};

/* harmony default export */ __webpack_exports__["default"] = (camelToSentenceCase);

/***/ }),

/***/ "./src/utils/createRowValue.js":
/*!*************************************!*\
  !*** ./src/utils/createRowValue.js ***!
  \*************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _createTitle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./createTitle */ "./src/utils/createTitle.js");
/* harmony import */ var _formatNumber__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./formatNumber */ "./src/utils/formatNumber.js");
/* harmony import */ var _filteredValues__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./filteredValues */ "./src/utils/filteredValues.js");




var createRowValue = function createRowValue(_ref) {
  var value = _ref.value,
      rowLabel = _ref.rowLabel,
      kind = _ref.kind;
  var isNumber = _filteredValues__WEBPACK_IMPORTED_MODULE_2__["default"].includes(rowLabel);
  var isCashies = rowLabel === "store" || rowLabel === "agent" || rowLabel === "cashiesTitle";

  if (isNumber) {
    return Object(_formatNumber__WEBPACK_IMPORTED_MODULE_1__["default"])(value, rowLabel, kind);
  }

  if (isCashies) {
    return Object(_createTitle__WEBPACK_IMPORTED_MODULE_0__["default"])(value, false).replace(/ +(?= )/g, "");
  }

  return value;
};

/* harmony default export */ __webpack_exports__["default"] = (createRowValue);

/***/ }),

/***/ "./src/utils/createSlides.js":
/*!***********************************!*\
  !*** ./src/utils/createSlides.js ***!
  \***********************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var core_js_modules_es_array_flat_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.flat.js */ "./node_modules/gatsby/node_modules/core-js/modules/es.array.flat.js");
...
/* harmony import */ var core_js_modules_es_array_unscopables_flat_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.array.unscopables.flat.js */ "./node_modules/gatsby/node_modules/core-js/modules/es.array.unscopables.flat.js");
...
/* harmony import */ var _createRowValue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./createRowValue */ "./src/utils/createRowValue.js");
/* harmony import */ var _filteredValues__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./filteredValues */ "./src/utils/filteredValues.js");




var filteredLabels = ["graphData", "kind"];

var createRow = function createRow(label, value, kind) {
  var isValue = _filteredValues__WEBPACK_IMPORTED_MODULE_3__["default"].includes(kind);
  var rowLabel = Object(_createRowValue__WEBPACK_IMPORTED_MODULE_2__["default"])({
...
var createSlideRows = function createSlideRows(dataValue) {
  return dataValue.map(function (item) {
    var rows = Object.entries(item).filter(function (_ref) {
      var _ = _ref[0],
          value = _ref[1];
      return value !== undefined;
    }).filter(function (_ref2) {
      var label = _ref2[0];
      return !filteredLabels.includes(label);
    }).map(function (_ref3) {
      var label = _ref3[0],
          value = _ref3[1];
      return createRow(label, value, item.kind);
    });
    var storeName = rows.filter(function (row) {
      return row.rowLabel === "Store";
    }).map(function (row) {
      return row.rowValue;
    }).pop();
    return {
...
var createSlideMapData = function createSlideMapData(dataValue) {
  return dataValue.map(function (item) {
    return Object.entries(item).filter(function (_ref4) {
      var _ = _ref4[0],
          value = _ref4[1];
      return value !== undefined;
...
var createSlide = function createSlide(item) {
  var dataLabel = item.dataLabel,
      dataValue = item.dataValue;
  var slideLabel = item.dataLabel;
  var slideTitle = Object(_createRowValue__WEBPACK_IMPORTED_MODULE_2__["default"])({
    value: dataLabel,
    rowLabel: "cashiesTitle",
    kind: ""
  });
  var slideMapData = createSlideMapData(dataValue);
  var slideContent = createSlideRows(dataValue).map(function (item) {
    var storeName = item.storeName;
    item.storeInfo = slideMapData.filter(function (row) {
      return row.storeData.name === storeName;
    }).flat().pop();
...
var createSlides = function createSlides(data, top) {
  if (top === void 0) {
    top = 0;
  }
...
/* harmony default export */ __webpack_exports__["default"] = (createSlides);

/***/ }),

/***/ "./src/utils/createTitle.js":
/*!**********************************!*\
  !*** ./src/utils/createTitle.js ***!
  \**********************************/
/*! exports provided: default */
...
/* harmony import */ var _camelToSentenceCase__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./camelToSentenceCase */ "./src/utils/camelToSentenceCase.js");





var createTitle = function createTitle(key, breakFirst) {
  var title = Object(_camelToSentenceCase__WEBPACK_IMPORTED_MODULE_2__["default"])(key);

  if (key === "total") {
    return /*#__PURE__*/Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsx"])("strong", {
      className: "text-bold",
      children: title
    });
  }
  ...
  if (breakFirst) {
    var wordArray = title.split(" ").filter(function (word) {
      return word !== "";
    });

    if (wordArray.length > 0) {
      var firstItem = wordArray[0];
      var restItems = wordArray.slice(1).join(" ");
      title = /*#__PURE__*/Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsxs"])(react__WEBPACK_IMPORTED_MODULE_1__["Fragment"], {
        children: [firstItem, /*#__PURE__*/Object(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__["jsx"])("br", {}), restItems]
      });
    }
  }
...
module.exports = JSON.parse("[{\"name\":\"Glen Innes\",\"area\":\"Auckland\",\"latLong\":{\"lon\":174.85524499999997,\"lat\":-36.8773484}},{\"name\":\"Henderson\",\"area\":\"Auckland\",\"latLong\":{\"lon\":174.63316989999998,\"lat\":-36.8825277}},{\"name\":\"Panmure\",\"area\":\"Auckland\",\"latLong\":{\"lon\":174.85457350000001,\"lat\":-36.899429}},{\"name\":\"Mount Roskill\",\"area\":\"Auckland\",\"latLong\":{\"lon\":174.7418404,\"lat\":-36.9035989}},{\"name\":\"Onehunga\",\"area\":\"Auckland\",\"latLong\":{\"lon\":174.78593,\"lat\":-36.9226193}},{\"name\":\"Otahuhu\",\"area\":\"Auckland\",\"latLong\":{\"lon\":174.84047839999994,\"lat\":-36.9413257}},{\"name\":\"Otara\",\"area\":\"Auckland\",\"latLong\":{\"lon\":174.87354879999998,\"lat\":-36.9608041}},{\"name\":\"Manukau\",\"area\":\"Auckland\",\"latLong\":{\"lon\":174.88046580000002,\"lat\":-36.9866757}},{\"name\":\"Takanini\",\"area\":\"Auckland\",\"latLong\":{\"lon\":174.90007879999996,\"lat\":-37.0252987}},{\"name\":\"Papakura\",\"area\":\"Auckland\",\"latLong\":{\"lon\":174.94551460000002,\"lat\":-37.0641686}},{\"name\":\"Pukekohe\",\"area\":\"Auckland\",\"latLong\":{\"lon\":174.90409279999994,\"lat\":-37.19981730000001}},{\"name\":\"Tauranga\",\"area\":\"Bay of Plenty\",\"latLong\":{\"lon\":176.16916070000002,\"lat\":-37.688189}},{\"name\":\"Hamilton East\",\"area\":\"Waikato\",\"latLong\":{\"lon\":175.2939867,\"lat\":-37.7727176}},{\"name\":\"Hamilton Central\",\"area\":\"Waikato\",\"latLong\":{\"lon\":175.27843499999994,\"lat\":-37.7845794}},{\"name\":\"Rotorua\",\"area\":\"Bay of Plenty\",\"latLong\":{\"lon\":176.25191510000002,\"lat\":-38.1370796}},{\"name\":\"New Plymouth\",\"area\":\"Taranaki\",\"latLong\":{\"lon\":174.07830680000006,\"lat\":-39.0562885}},{\"name\":\"Hastings\",\"area\":\"Hawkes Bay\",\"latLong\":{\"lon\":176.83338200000003,\"lat\":-39.63251899999999}},{\"name\":\"Wanganui\",\"area\":\"Manawatu-Wanganui\",\"latLong\":{\"lon\":175.048041,\"lat\":-39.930739}},{\"name\":\"Palmerston North\",\"area\":\"Manawatu-Wanganui\",\"latLong\":{\"lon\":175.6137122,\"lat\":-40.3547088}},{\"name\":\"Porirua\",\"area\":\"Wellington\",\"latLong\":{\"lon\":174.83952720000002,\"lat\":-41.1298946}},{\"name\":\"Lower Hutt\",\"area\":\"Wellington\",\"latLong\":{\"lon\":174.90479949999997,\"lat\":-41.2091207}},{\"name\":\"Linwood\",\"area\":\"Christchurch\",\"latLong\":{\"lon\":172.6732809,\"lat\":-43.5327557}},{\"name\":\"Dunedin South\",\"area\":\"Otago\",\"latLong\":{\"lon\":170.49908500000004,\"lat\":-45.8939078}}]");

/***/ }),

/***/ "./src/utils/filteredValues.js":
/*!*************************************!*\
  !*** ./src/utils/filteredValues.js ***!
  \*************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var filteredValues = ["pawns", "value", "satisfaction"];
/* harmony default export */ __webpack_exports__["default"] = (filteredValues);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var numberIsInteger = function numberIsInteger(num) {
  return Number.isInteger(num);
};

var formatNumber = function formatNumber(value, key, kind) {
  var isMoneyValue = key === "value" && kind === "value";
  var isPercentage = kind === "satisfaction";
  var label = value;
  var shouldRemoveZeros = numberIsInteger(label);
...
!(function webpackMissingModule() { var e = new Error("Cannot find module '@visx/scale'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
!(function webpackMissingModule() { var e = new Error("Cannot find module 'd3-scale-chromatic'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
/* harmony import */ var _createRowValue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./createRowValue */ "./src/utils/createRowValue.js");
/* harmony import */ var _filteredValues__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./filteredValues */ "./src/utils/filteredValues.js");
/* harmony import */ var _data_stores_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./data/stores.json */ "./src/utils/data/stores.json");
var _data_stores_json__WEBPACK_IMPORTED_MODULE_5___namespace = /*#__PURE__*/__webpack_require__.t(/*! ./data/stores.json */ "./src/utils/data/stores.json", 1);
...
var getChartColor = !(function webpackMissingModule() { var e = new Error("Cannot find module '@visx/scale'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())({
  range: !(function webpackMissingModule() { var e = new Error("Cannot find module 'd3-scale-chromatic'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())
});

var generateChartData = function generateChartData(item, index) {
  ...
  var formattedValue = Object(_createRowValue__WEBPACK_IMPORTED_MODULE_3__["default"])({
    value: value,
    rowLabel: kind,
    kind: kind
  });

  if (_filteredValues__WEBPACK_IMPORTED_MODULE_4__["default"].includes(kind)) {
    delete item.value;
  ...
  var strokeColor = getChartColor(index);
  var backgroundColor = color__WEBPACK_IMPORTED_MODULE_1___default()(strokeColor).lighten(0.125).alpha(0.25).toString();
  var store = Object(_createRowValue__WEBPACK_IMPORTED_MODULE_3__["default"])({
    value: item.store,
    rowLabel: "cashiesTitle",
    kind: ""
  });
  var storeData = _data_stores_json__WEBPACK_IMPORTED_MODULE_5__.filter(function (i) {
    return i.name === store;
  }).pop();
  var graphData = {
...
var getValue = function getValue(_ref) {
  var transactions = _ref.transactions,
      key = _ref.key;
  return transactions.map(function (value) {
    return value[key];
  });
};

var getTop = function getTop(_ref2) {
  var keys = _ref2.keys,
  ...
  return keys.map(function (key) {
    return {
      ...
      dataValue: getValue({
        ...
        return generateChartData(item, index);
      }).sort(function (a, b) {
        return b.graphData.value - a.graphData.value;
      })
    };
  });
};

var getOriginalKeys = function getOriginalKeys(data) {
  return Object.keys(data.reduce(function (result, current) {
    return Object.assign(result, current);
  }, {}));
};

var getRankings = function getRankings(_ref3) {
  var transactions = _ref3.transactions;

  if (transactions) {
    var keys = getOriginalKeys(transactions);
    return getTop({
      transactions: transactions,
      keys: keys
    });
...
/* harmony default export */ __webpack_exports__["default"] = (getRankings);

/***/ }),

/***/ "./src/utils/handleForecastData.js":
/*!*****************************************!*\
  !*** ./src/utils/handleForecastData.js ***!
  \*****************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _updateClimacellCode__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./updateClimacellCode */ "./src/utils/updateClimacellCode.js");


var handleForecastData = function handleForecastData(_ref) {
  var object = _ref.object,
      kind = _ref.kind,
      method = _ref.method,
      options = _ref.options;
  var forecast = object[kind][method].filter(function (store) {
    return store.name === options.storeName;
  }).map(function (store) {
    return Object(_updateClimacellCode__WEBPACK_IMPORTED_MODULE_0__["default"])(store);
  }).pop();
  return {
    forecast: forecast
  };
...
/* harmony default export */ __webpack_exports__["default"] = (handleForecastData);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _handleTransactionsData__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./handleTransactionsData */ "./src/utils/handleTransactionsData.js");
/* harmony import */ var _handleNewsData__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./handleNewsData */ "./src/utils/handleNewsData.js");
/* harmony import */ var _handleForecastData__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./handleForecastData */ "./src/utils/handleForecastData.js");



var knownMethods = ["news", "forecast", "hourlyLoans", "latestLoanApplications"];
var unchangedDataMethods = ["hourlyLoans", "latestLoanApplications"];
...
var handleMessage = function handleMessage(_ref) {
  var object = _ref.object,
      ...
      method = _ref$method === void 0 ? null : _ref$method;
  ...
  if (object && object[kind]) {
    if (object[kind].transactions) {
      message = Object.assign({}, message, Object(_handleTransactionsData__WEBPACK_IMPORTED_MODULE_0__["default"])({
        object: object,
        kind: kind,
        options: options
      }));
    ...
    if (knownMethods.includes(method) && object[kind][method] && object[kind][method].length > 0) {
      message.kind = method;
      ...
      if (method === "news") {
        message = Object.assign({}, message, Object(_handleNewsData__WEBPACK_IMPORTED_MODULE_1__["default"])({
          object: object,
          kind: kind,
          method: method
        }));
      ...
      if (method === "forecast") {
        message = Object.assign({}, message, Object(_handleForecastData__WEBPACK_IMPORTED_MODULE_2__["default"])({
          object: object,
          kind: kind,
          method: method,
          options: options
...
var handleNewsData = function handleNewsData(_ref) {
  var object = _ref.object,
      kind = _ref.kind,
      method = _ref.method;
  var news = object[kind][method].map(function (item) {
    item.content = item.content ? item.content.replace(/ *\[[^)]*\] */g, "") : item.description ? item.description : "";
    item.publishedAt = item.publishedAt ? Object(date_fns_format__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(item.publishedAt), "dd/MM/yyyy hh:mm a") : Object(date_fns_format__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(), "dd/MM/yyyy hh:mm a");
    return item;
  });
  return {
    news: news
...
/* harmony default export */ __webpack_exports__["default"] = (handleNewsData);

/***/ }),

/***/ "./src/utils/handleResponseFromAPI.js":
/*!********************************************!*\
  !*** ./src/utils/handleResponseFromAPI.js ***!
  \********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var handleResponseFromAPI = function handleResponseFromAPI(response, name) {
  var _object;

  var object = (_object = {}, _object[name] = null, _object);
...
/* harmony default export */ __webpack_exports__["default"] = (handleResponseFromAPI);

/***/ }),

/***/ "./src/utils/handleTransactionsData.js":
/*!*********************************************!*\
  !*** ./src/utils/handleTransactionsData.js ***!
  \*********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _createSlides__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./createSlides */ "./src/utils/createSlides.js");
/* harmony import */ var _getRankings__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./getRankings */ "./src/utils/getRankings.js");



var handleTransactionsData = function handleTransactionsData(_ref) {
  var object = _ref.object,
      kind = _ref.kind,
      options = _ref.options;
  var transactions = object[kind].transactions;
  var sorted = Object(_getRankings__WEBPACK_IMPORTED_MODULE_1__["default"])({
    transactions: transactions
  });
  var saved = JSON.stringify(sorted);
  var slides = Object(_createSlides__WEBPACK_IMPORTED_MODULE_0__["default"])(JSON.parse(saved), options);
  return {
    sorted: sorted,
    slides: slides
  };
...
/* harmony default export */ __webpack_exports__["default"] = (handleTransactionsData);

/***/ }),

/***/ "./src/utils/restFunctions.js":
/*!************************************!*\
  !*** ./src/utils/restFunctions.js ***!
  \************************************/
/*! exports provided: getShoppingListData */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getShoppingListData", function() { return getShoppingListData; });
/* harmony import */ var react_data_fetching__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react-data-fetching */ "./node_modules/react-data-fetching/esm/react-data-fetching.js");

var apiUrl = "/api/";

var getShoppingListData = function getShoppingListData(method) {
  var url = "" + apiUrl + method;
  return Object(react_data_fetching__WEBPACK_IMPORTED_MODULE_0__["requestToApi"])({
    url: url,
    method: "GET",
    timeout: 35000,
    ...
    onIntercept: function onIntercept(result) {}
  });
};
...
/***/ "./src/utils/snakeToSentenceCase.js":
/*!******************************************!*\
  !*** ./src/utils/snakeToSentenceCase.js ***!
  \******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var snakeToSentenceCase = function snakeToSentenceCase(key) {
  return key.split("_").map(function (word) {
    return "" + word.charAt(0).toUpperCase() + word.slice(1);
  }).join(" ").trim();
};

/* harmony default export */ __webpack_exports__["default"] = (snakeToSentenceCase);

/***/ }),

/***/ "./src/utils/updateClimacellCode.js":
/*!******************************************!*\
  !*** ./src/utils/updateClimacellCode.js ***!
  \******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
!(function webpackMissingModule() { var e = new Error("Cannot find module 'suncalc'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
/* harmony import */ var date_fns_isWithinInterval__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! date-fns/isWithinInterval */ "./node_modules/date-fns/esm/isWithinInterval/index.js");
...
/* harmony import */ var _snakeToSentenceCase__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./snakeToSentenceCase */ "./src/utils/snakeToSentenceCase.js");
/* harmony import */ var _camelToSentenceCase__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./camelToSentenceCase */ "./src/utils/camelToSentenceCase.js");
...
var dayNightWeatherCodes = ["clear", "mostly_clear", "partly_cloudy"];
var weatherKeys = ["temp", "feels_like", "humidity", "precipitation", "precipitation_probability"];

var updateWeatherCode = function updateWeatherCode(_ref) {
  var weatherCode = _ref.weatherCode,
      observationTime = _ref.observationTime,
      sunrise = _ref.sunrise,
      sunset = _ref.sunset;
  var isDayOrNight = Object(date_fns_isWithinInterval__WEBPACK_IMPORTED_MODULE_1__["default"])(observationTime, {
    start: sunrise,
    end: sunset
  }) ? "_day" : "_night";
...
var updateValue = function updateValue(item) {
  return "" + Math.round(item === null || item === void 0 ? void 0 : item.value) + ((item === null || item === void 0 ? void 0 : item.units) === "C" ? "°" : "") + (item === null || item === void 0 ? void 0 : item.units);
};

var updateUnits = function updateUnits(object, key) {
...
var formatObservationTime = function formatObservationTime(observationTime, kind) {
  return kind === "day" ? Object(date_fns_format__WEBPACK_IMPORTED_MODULE_2__["default"])(observationTime, "EEE dd MMM") : Object(date_fns_format__WEBPACK_IMPORTED_MODULE_2__["default"])(observationTime, "h:mm a").toLowerCase();
};

var formatMoonPhase = function formatMoonPhase(phase) {
  switch (phase) {
    case phase === 0:
      return "newMoon";
...
var updateObjectKey = function updateObjectKey(object, latLong, kind) {
  var value = object.observation_time.value,
      weatherCode = object.weather_code.value;
  var lat = latLong.lat,
      lon = latLong.lon;
  var observationTime = new Date(value);

  var _SunCalc$getTimes = !(function webpackMissingModule() { var e = new Error("Cannot find module 'suncalc'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).getTimes(observationTime, lat, lon),
      sunrise = _SunCalc$getTimes.sunrise,
      sunset = _SunCalc$getTimes.sunset;

  var _SunCalc$getMoonIllum = !(function webpackMissingModule() { var e = new Error("Cannot find module 'suncalc'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).getMoonIllumination(observationTime),
      phase = _SunCalc$getMoonIllum.phase;

  var formattedMoonPhase = formatMoonPhase(phase);
  var moonPhase = {
    phase: formattedMoonPhase,
    phaseTitle: Object(_camelToSentenceCase__WEBPACK_IMPORTED_MODULE_5__["default"])(formattedMoonPhase)
  };
  weatherKeys.map(function (key) {
    if (object[key]) {
      updateUnits(object, key);
    }
  });
  object.weather_code.title = Object(_snakeToSentenceCase__WEBPACK_IMPORTED_MODULE_4__["default"])(weatherCode);
...
var updateClimacellCode = function updateClimacellCode(data) {
  var latLong = data.latLong,
      hourly = data.hourly;
  var now = new Date(new Date().toISOString());
  var filteredHourly = hourly.filter(function (hour) {
    var value = hour.observation_time.value;
    return Object(date_fns_isAfter__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(value), now);
  });
  data.realTime = updateObjectKey(data.realTime, latLong, "day");
  data.daily = data.daily.map(function (day) {
    return updateObjectKey(day, latLong, "day");
  }).slice(0, 6);
  data.hourly = filteredHourly.map(function (hour) {
    return updateObjectKey(hour, latLong, "hour");
  }).slice(0, 6);
  return data;
};

/* harmony default export */ __webpack_exports__["default"] = (updateClimacellCode);

/***/ })

/******/ });
//# sourceMappingURL=9d4b04f7abdebc230d20.worker.js.map